...
platform_post_image () {
	...
	template/platform-post-image.sh
}

device_post_image () {
	echo "device-post-image.sh"
	template/device-post-image.sh
}
...
[ -f template/platform-post-image.sh ] && platform_post_image

[ -f template/device-post-image.sh ] && device_post_image
